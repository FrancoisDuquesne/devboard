...
- **Todo → issue detail 404** — opening an issue from a todo node failed with a 404 because `projectId` was hardcoded to `0`. The project ID is now carried through the normalization pipeline for both GitLab and GitHub providers.
